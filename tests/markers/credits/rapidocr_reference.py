...
# ruff: noqa: F841, UP006, UP007, UP035, UP045
...
# From text_detect.py's TextDetector, as module functions (self dropped; the limit settings are arguments).


def get_preprocess(max_wh, limit_type, limit_side_len, mean, std):
    if limit_type == "min":
        ...
        limit_side_len = 2000
    return DetPreProcess(limit_side_len, limit_type, mean, std)
