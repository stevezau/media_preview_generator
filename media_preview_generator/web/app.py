...
def _schedule_weekly_online_recheck() -> None:
    ...
    Runs after the restart requeue, so a revived re-check is found and not queued twice. Never raises.
    """
    try:
        from ..markers.triggers import schedule_online_recheck
