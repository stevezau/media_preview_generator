...
VARIANTS={
 "alg2_ac2":  ["-ac","2","-f","chromaprint","-algorithm","2"],
}
...
for name, opts in VARIANTS.items():
    # measured: alg1 0.1238 s/point, alg2 (chromaprint Test3, no frame overlap) 0.3715, alg4 0.0929
    fp.POINT_S = (2048/2/11025) if "alg4" in name else (4096/11025 if "alg2" in name else 4096/11025/3)
